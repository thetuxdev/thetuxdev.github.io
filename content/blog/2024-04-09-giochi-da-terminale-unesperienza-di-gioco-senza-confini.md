...
#### **Su Linux:**
  ...
  * Se Nethack non è disponibile nei repository ufficiali o vuoi installare una versione più recente, puoi scaricare il codice sorgente dal sito ufficiale di Nethack (<https: www.nethack.org=""></https:>) e compilare il gioco seguendo le istruzioni incluse nel file README.
...
#### **Su Windows:**
  ...
  * Per gli utenti di Windows, è possibile scaricare una versione pre-compilata di Nethack direttamente dal sito ufficiale di Nethack (<https: www.nethack.org=""></https:>).
...
#### **Su Linux:**
  ...
  * Se Bastet non è disponibile nei repository ufficiali o vuoi installare una versione più recente, puoi scaricare il codice sorgente dal repository GitHub ufficiale di Bastet (<https: bastet="" fph="" github.com="">) e compilare il gioco seguendo le istruzioni incluse nel file README.
