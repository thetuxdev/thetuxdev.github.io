...
<img loading="lazy" decoding="async" width="800" height="452" src="http://albertoreineri.it/wp-content/uploads/2024/04/13863751533_035ef21704_c-e1712682636414.jpg" alt="" class="wp-image-7496" srcset="https://albertoreineri.it/wp-content/uploads/2024/04/13863751533_035ef21704_c-e1712682636414.jpg 800w, https://albertoreineri.it/wp-content/uploads/2024/04/13863751533_035ef21704_c-e1712682636414-300x170.jpg 300w, https://albertoreineri.it/wp-content/uploads/2024/04/13863751533_035ef21704_c-e1712682636414-768x434.jpg 768w" sizes="(max-width: 800px) 100vw, 800px" /> </figure>

### Installazione {.wp-block-heading}

#### **Su Linux:** {.wp-block-heading}

  * Nethack può essere difficile da trovare nei repository ufficiali delle distribuzioni Linux più comuni. Puoi provare ad installarlo utilizzando il gestore di pacchetti della tua distribuzione. Se non lo trovi puoi installarlo tramite snap:
    `sudo snap install nethack`
  * Se Nethack non è disponibile nei repository ufficiali o vuoi installare una versione più recente, puoi scaricare il codice sorgente dal sito ufficiale di Nethack (<https://www.nethack.org/>) e compilare il gioco seguendo le istruzioni incluse nel file README.

#### **Su macOS:** {.wp-block-heading}

  * Nethack può essere facilmente installato su macOS utilizzando Homebrew, un gestore di pacchetti per macOS. Se non hai già installato Homebrew, puoi farlo seguendo le istruzioni sul sito ufficiale di Homebrew (https://brew.sh/).
  * Dopo aver installato Homebrew, apri il terminale e digita il seguente comando:
    `brew install nethack`

#### **Su Windows:** {.wp-block-heading}

  * Per gli utenti di Windows, è possibile scaricare una versione pre-compilata di Nethack direttamente dal sito ufficiale di Nethack (<https://www.nethack.org/>).
  * Una volta scaricato il file di installazione, eseguilo e segui le istruzioni visualizzate sullo schermo per completare l&#8217;installazione di Nethack sul tuo sistema Windows.
...
## **2. Bastet: Una Versione Tattica di Tetris** {.wp-block-heading}<figure class="wp-block-image size-large">

<img loading="lazy" decoding="async" width="1340" height="819" src="http://albertoreineri.it/wp-content/uploads/2024/04/bastet.svg" alt="" class="wp-image-7495" /> </figure>
...
Per installare Bastet sul tuo sistema, segui questi passaggi:

#### **Su Linux:** {.wp-block-heading}

  * Bastet è disponibile nei repository di molte distribuzioni Linux. Puoi installarlo utilizzando il gestore di pacchetti della tua distribuzione. Ad esempio, su Ubuntu e derivate, puoi digitare il seguente comando nel terminale:
    `sudo apt-get install bastet`
  * Se Bastet non è disponibile nei repository ufficiali o vuoi installare una versione più recente, puoi scaricare il codice sorgente dal repository GitHub ufficiale di Bastet (<https://github.com/fph/bastet>) e compilare il gioco seguendo le istruzioni incluse nel file README.
